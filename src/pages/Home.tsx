...
export function Home() {
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-hero-from via-hero-via to-hero-to px-4 py-32 text-white">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <h1 className="mb-6 text-5xl font-extrabold leading-tight tracking-tight sm:text-6xl lg:text-7xl">
            {t.hero.titleLine1}
            <br />
            <span className="text-hero-hl">{t.hero.titleLine2}</span>
          </h1>

          <p className="mx-auto mb-10 max-w-2xl text-lg leading-relaxed text-hero-muted">
            {t.hero.subtitle}
          </p>
      ...
      {/* ── Brand strip ── */}
      <section className="bg-brand px-4 py-5">
      ...
      <section className="bg-white px-4 py-20">
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div>
              <h2 className="mb-4 text-4xl font-extrabold leading-tight text-heading">
                {t.trust.title}
              </h2>
      ...
      <section className="bg-white px-4 py-20">
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 text-center">
            <h2 className="mb-3 text-3xl font-extrabold text-heading">
            ...
            {t.testimonials.items.slice(0, 3).map((item, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-brand text-sm font-bold text-on-brand">
                    {item.name[0]}
                  </div>
                  <div>
      ...
      {/* ── CTA banner ── */}
      <section className="bg-brand px-4 py-20">
